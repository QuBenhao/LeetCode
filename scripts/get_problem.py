...
def process_single_problem(problem_id: str, problem_slug: str, problem_title: str, force: bool = False, file=None):
...
def main(problem_id: Optional[str], problem_slug: Optional[str], force: bool = False,
         cookie: Optional[str] = None, fetch_all: bool = False, premium_only: bool = False,
    ...
    if not fetch_all:
        ...
        process_single_problem(problem_id, problem_slug, problem_title, force)
    else:
        ...
        for question in questions:
            try:
                process_single_problem(question["frontendQuestionId"], question["titleSlug"], question["title"],
                                   force, file=file)
...
if __name__ == '__main__':
    ...
    main(args.problem_id, args.problem_slug, args.force, cke, args.fetch_all, args.premium_only, args.debug_file)
    sys.exit()
