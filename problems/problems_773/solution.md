...
### 解题思路
这是特别经典的 8 puzzle，有两种常见的启发式函数:
1. 不在应该在的位置上的元素个数；
2. 每个元素到应该去的位置的曼哈顿距离。

因为第一个效果更好,所以这里用了第一个。
<br>
关于N*M puzzle问题中, M为奇数时, 逆序对数为奇数个时无解这一结论的[证明](https://blog.csdn.net/qq_45458915/article/details/103313671)
